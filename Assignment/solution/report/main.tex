...
The CDF of $T$ is given by
	...
	By convolution,
	\begin{align}
		F_T(t) &= \int_{-\infty}^{\infty} F_{U_2}(t-x) p_{U_1}(x) \der{x}
	\end{align}
...
Refer figure \ref{fig:7.1} for graph in rectangular axis and figure \ref{fig:7.1_semilog} for graph in semilog axis. $P_e$ is only dependent on $\gamma$
